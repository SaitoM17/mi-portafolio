function SIEM() {
  return (
    <div style={{ padding: "2rem" }}>
      <h2>📊 Sistema de Información Empresarial Mexicano (SIEM)</h2>
      <p>
        Analizar la distribución y características de las empresas registradas en el 
        Sistema de Información Empresarial Mexicano (SIEM) para obtener insights sobre 

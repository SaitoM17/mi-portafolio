...
function Projects() {
  const proyectos = [
    ...
    },
    {
      ...
      imagen: "public/img/Auto_Price.jpg",
    ...
    },
    {
      ...
      imagen: "public/img/SuperStore_Sales.jpg",
      tecnologias: "Python, Pandas, Numpy, Matplotlib, Seaborn, Jupyter Notebook, Power BI,Git & GitHub, etc..",
    ...
    },
    {
      ...
      imagen: "public/img/Amazon_Delivery.jpg",
    ...
    },
    {
      ...
      imagen: "public/img/Tortillas.png",
    ...
    },
    {
      ...
      imagen: "public/img/Trade_Statistics.jpg",
      tecnologias: "Python, Pandas, Numpy, Matplotlib, Seaborn, Jupyter Notebook, Kaggle, Git & GitHub.",
      pagina: "/Mexico-trade",
          ...
          <div className="project-content">
            ...
            <div className="project-links">
              ...
              <a href={p.link} target="_blank" rel="noopener noreferrer">
                <img src={"public/icon/github.png"} alt={p.nombre} className="repositor-icon" />
              </a>
            </div>
          </div>
